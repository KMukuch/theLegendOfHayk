...
void set_objective_array(cJSON *json_quest_objective_array, struct Game_Quest_Objective *objective_array, int objective_array_size);
void set_game_quest(cJSON *json_quest_item, struct Game_Quest *game_quest);

void init_game_quest_manager(struct Game_Quest_Manager *game_quest_manager);

void update_game_quest_manager();
